...
function App() {
    ...
    useEffect(() => {
        ...
        browser.storage.local.get(['selectedText', 'settings']).then(async (res: any) => {
            let initialText = res.selectedText || '';
            ...
            <main className="content">
                ...
                <section className="input-area">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                        ...
                        <button className="fetch-btn" onClick={handleFetchContent} title={t.fetch_page_content || 'Fetch Page Content'}>
